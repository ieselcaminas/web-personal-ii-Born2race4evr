...
class Post
{
    ...
    #[Assert\NotBlank(message: "El campo `Title` es obligatorio")]
    private ?string $title = null;

    #[ORM\Column(type: Types::TEXT)]
    #[Assert\NotBlank(message: "El campo `Content` es obligatorio")]
    ...
    #[ORM\Column(length: 255)]
    #[Assert\NotBlank(message: "El campo `Image` es obligatorio")]
    ...
    public function setNumComments(int $numComments): static
    {
